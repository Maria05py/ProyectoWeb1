...
infospot7.element.innerHTML = `
    <div class="infobox bg-gold w320">
        ...
        <p>Nuestro techo curvo está construido con madera certificada de bosques sostenibles de Costa Rica. La arquitectura se integra armoniosamente con el entorno natural.</p>
        
        <!-- ACORDEÓN DESPLEGABLE -->
        <details class="accordion-madera">
            <summary class="accordion-header">
                <span>🌳 Tipos de Madera Utilizados</span>
            </summary>
            <div class="accordion-content">
                <div class="madera-item">
                    <strong>Teca Costarricense</strong>
                    <p>✓ Resistencia extrema a insectos y humedad<br>
                    ✓ Durabilidad: +100 años<br>
                    ✓ Color dorado natural<br>
                    ✓ Precio premium</p>
                </div>
                <div class="madera-item">
                    <strong>Roble Blanco</strong>
                    <p>✓ Madera estructural principal<br>
                    ✓ Resistencia a cambios climáticos<br>
                    ✓ Certificado FSC<br>
                    ✓ Sostenible y renovable</p>
                </div>
                <div class="madera-item">
                    <strong>Guanacaste</strong>
                    <p>✓ Acabados interiores<br>
                    ✓ Belleza natural única<br>
                    ✓ Madera local costarricense<br>
                    ✓ Propiedades antiinsectos naturales</p>
                </div>
            </div>
        </details>
        ...
        <details class="accordion-madera">
            <summary class="accordion-header">
                <span>♻️ Beneficios Ambientales</span>
            </summary>
            <div class="accordion-content">
                <p>✓ <strong>Carbono Neutral:</strong> Las maderas provienen de bosques que se replantean constantemente</p>
                <p>✓ <strong>Biodiversidad:</strong> Protegemos 500 hectáreas de bosque nuboso</p>
                <p>✓ <strong>Certificación FSC:</strong> Garantiza prácticas sostenibles internacionalmente</p>
                <p>✓ <strong>Cero deforestación:</strong> Cada árbol talado se replanta con 3 nuevos árboles</p>
                <p>✓ <strong>Empleos locales:</strong> Apoyo a carpinteros y artesanos costarricenses</p>
            </div>
        </details>
        ...
        <details class="accordion-madera">
            <summary class="accordion-header">
                <span>🛠️ Mantenimiento y Durabilidad</span>
            </summary>
            <div class="accordion-content">
                <p><strong>Cuidados especiales:</strong></p>
                <p>• Tratamiento de hongos cada 5 años<br>
                • Sellado protector anual<br>
                • Inspección estructural anual<br>
                • Limpieza con productos naturales</p>
                <p style="margin-top: 10px;"><strong>Garantía:</strong> 25 años contra defectos estructurales</p>
                <p style="margin-top: 8px; font-size: 12px; opacity: 0.9;">Se estima que la estructura del techo durará más de 100 años con el mantenimiento adecuado.</p>
            </div>
        </details>
